...
var file_sum_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x73, 0x2d, 0x67, 0x6f, 0x2f, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f,
...
func file_sum_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sum_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_sum_proto_msgTypes[1].Exporter = func(v any, i int) any {
